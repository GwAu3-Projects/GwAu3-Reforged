...
namespace GW {
    ...
    private:
        ...
        bool HandleArrayRequest(const PipeRequest& request, PipeResponse& response);
        bool HandleBatchReadRequest(const PipeRequest& request, PipeResponse& response);
        bool HandleHeartbeatRequest(const PipeRequest& request, PipeResponse& response);
